...
const styles = StyleSheet.create({
  ...
  addSuggestBtnText: { color: '#EA580C', fontSize: 12, fontWeight: '600' },
  addMedBtn: {
  ...
  chipActiveOrange: { backgroundColor: '#FEF3C7', borderColor: '#FCD34D' },
  chipText: { fontSize: 13, color: '#6B7280', fontWeight: '500' },
  chipTextActiveRed: { color: '#DC2626', fontWeight: '700' },
  chipTextActiveOrange: { color: '#D97706', fontWeight: '700' },
  pendingSection: {
  ...
  pendingItemName: { fontSize: 13, color: '#374151', flex: 1 },
  pendingBadge: {
  ...
  removeBtn: { fontSize: 16, color: '#EF4444', paddingLeft: 12 },
  // Modal
  modalOverlay: {
    flex: 1,
  ...
  suggestHint: { fontSize: 13, color: '#6B7280', lineHeight: 18 },
  field: { gap: 6 },
  ...
  medList: { maxHeight: 130, borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 10 },
  medOption: {
    paddingHorizontal: 14,
    paddingVertical: 10,
    borderBottomWidth: 1,
